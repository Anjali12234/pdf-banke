        ...
        <div class="page-heading">
            ...
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="color: blue"><a href="{{ route('admin.documentList.index') }}">कानूनी
                            दस्तावेज List
                        </a></li>
                </ol>
            </nav>
        ...
        <div class="page-content fade-in-up">
            ...
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form action="{{ route('admin.documentList.update', $documentList) }}" method="POST"
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" id="title" type="text"
                                    value="{{ old('title', $documentList->title) }}" name="title" placeholder="Title">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" id="slug" type="text"
                                    value="{{ old('slug', $documentList->slug) }}" name="slug" placeholder="Slug">
                                <span class="text-warning">
                                    @error('slug')
                                        {{ $message }}
                                    @enderror

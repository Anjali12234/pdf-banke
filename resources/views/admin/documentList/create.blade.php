        ...
        <div class="page-heading">
            ...
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="color: blue"><a href="{{ route('admin.documentList.index') }}">कानूनी दस्तावेज List
                        </a></li>
                </ol>
            </nav>
        </div>
        <div class="page-content fade-in-up">
            ...
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form action="{{ route('admin.documentList.store','$documentList') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-sm-12 form-group">
                                <label for="title">Title</label>
                                <input class="form-control" id="title" type="text" value="{{ old('title', $documentList->title) }}"
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" id="english_title" type="text"
                                    value="{{ old('english_title', $documentList->english_title) }}" name="english_title"
                                    placeholder="Name">
                                <span class="text-warning">
                                    @error('english_title')
                                        {{ $message }}
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" id="slug" type="text" value="{{ old('slug', $documentList->slug) }}"
                                ...
                                <select name="document_category_id" id="document_category_id" class="form-control">
                                    ...
                                    @foreach ($documentCategorys as $documentCategory)
                                        <option
                                            ...
                                            {{ old('document_category_id', $documentList->document_category_id) == $documentCategory->id ? 'selected' : '' }}>
                                            {{ $documentCategory->title }}</option>
                                    @endforeach
                                </select>
                                <span class="text-warning">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" id="publisher" type="text" name="publisher"
                                    value="{{ old('publisher', $documentList->publisher) }}" placeholder="Publisher">
                                <span class="text-warning">
                                    @error('publisher')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" id="english_publisher" type="text" name="english_publisher"
                                    value="{{ old('english_publisher', $documentList->english_publisher) }}"
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input class="form-control" id="date" type="text"
                                    value="{{ old('publish_date', $documentList->publish_date) }}" name="publish_date">
                                <span class="text-warning">
                                    @error('publish_date ')
                                        {{ $message }}
                                    @enderror

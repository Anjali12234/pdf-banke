        ...
        <div class="page-heading">
            ...
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="color: blue"><a href="{{ route('admin.downloadList.index') }}">डाउनलोड List
                        </a></li>
                </ol>
            </nav>
        </div>
        <div class="page-content fade-in-up">
            ...
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form action="{{ route('admin.downloadList.update',$downloadList) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-sm-12 form-group">
                                <label for="title">Title</label>
                                <input class="form-control" id="title" type="text" value="{{ old('title', $downloadList->title) }}"
                            ...
                            <div class="col-sm-12 form-group">
                                <label>Slug</label>
                                <input class="form-control" type="text" value="{{ old('slug', $downloadList->slug) }}"

        ...
        <div class="page-content fade-in-up">
            <div class="row">
                <div class="col-xl-12">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">सुचना/ समाचार</div>
                            <div class="ibox-title">
                                <a href="{{ route('admin.newsList.create') }}" class="btn btn-primary float-right">
                                    ...
                                    @forelse ($newsLists as $key=>$newsList)
                                        <tr>
                                            ...
                                            <td>
                                              ...
                                              <td>
                                                <a class="btn btn-warning" href="{{ route('admin.newsList.show', $newsList) }}">
                                                    <i class="fa-sharp fa-solid fa-eye"></i>View</a>
                                                <a class="btn btn-primary" href="{{ route('admin.newsList.edit', $newsList) }}">

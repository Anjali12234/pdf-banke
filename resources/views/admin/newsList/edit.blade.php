        ...
        <div class="page-heading">
            ...
            <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="color: blue"><a href="{{ route('admin.newsList.index') }}">सुचना/ समाचार List
                        </a></li>
                </ol>
            </nav>
        </div>
        <div class="page-content fade-in-up">
            ...
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form action="{{ route('admin.newsList.update',$newsList) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <select name="news_category_id" id="category" class="form-control  select2">
                                    ...
                                    @foreach ($newsCategorys as $newsCategory)
                                        <option
                                            ...
                                            {{ old('news_category_id', $newsList->news_category_id) == $newsCategory->id ? 'selected' : '' }}>

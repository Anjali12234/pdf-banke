    ...
    <section class="container-fluid sections">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $farmerList->title ?? '' }}</li>
            </ol>
        </nav>

        <div class="row">
            <h5 class="title-dark">{{ $farmerList->title ?? '' }} </h5>
                    ...
                    <h4 class="title mb-3 ">सम्बन्धित कानूनी दस्तावेज </h4>
                        ...
                        <div class="bg-white  pdf-desc ml-4 mb-3">
                            <a href="" class=" card-01 mb-2 bg-white pl-5">
                                <h6 class="heading bg-white ">{{ $farmerList->title ?? '' }}</h6>
                                <p class="mt-2 sub-title bg-white">{{ $farmerList->publish_date ?? '' }} | PDF </p>
                            </a>
                        </div>
                </div>
